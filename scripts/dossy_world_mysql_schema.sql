...
-- 
-- This script creates all necessary tables for the Dossy World vault-filling game.
...
INSERT INTO users (id, username, email, password_hash, is_admin, balance) VALUES
    (UUID(), 'admin', 'admin@dossy.world', '$2a$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/X4bvXO4PJXJ4Z0Zni', TRUE, 0)
