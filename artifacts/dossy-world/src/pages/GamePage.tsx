...
import { Sparkles, RefreshCw, History, ChevronRight, Flame } from 'lucide-react'
        ...
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4">
          ...
          <div className="flex items-center gap-3">
            ...
            {authLoading ? (
              ...
              <UserDropdown onDeposit={() => setShowDepositModal(true)} onWithdraw={() => setShowWithdrawModal(true)} />
            ) : (
