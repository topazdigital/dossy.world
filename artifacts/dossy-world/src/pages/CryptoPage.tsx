...
const CRYPTO_OPTIONS: CryptoOption[] = [
  {
    ...
    address: process.env.VITE_BTC_ADDRESS || 'bc1q_CONFIGURE_BTC_ADDRESS_IN_ENV',
  ...
  },
  {
    ...
    symbol: 'USDT',
    network: 'TRC20 (TRON)',
    address: process.env.VITE_USDT_TRC20_ADDRESS || 'T_CONFIGURE_USDT_ADDRESS_IN_ENV',
    minDeposit: '10 USDT',
    confirmations: 20,
  ...
  },
  {
    ...
    symbol: 'USDT',
    network: 'BEP20 (BSC)',
    address: process.env.VITE_USDT_BEP20_ADDRESS || '0x_CONFIGURE_BEP20_ADDRESS_IN_ENV',
    minDeposit: '10 USDT',
    confirmations: 15,
    color: 'var(--neon-cyan)',
    icon: '₮',
