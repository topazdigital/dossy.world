      ...
      try {
        ...
        if (response.ok) {
          ...
          if (data.user?.is_admin) {
            ...
            router.replace('/ops-control-9f3a2b7c')
          }
        } else {
          router.replace('/ops-control-9f3a2b7c')
        }
  ...
  return (
    <div className="bg-background min-h-screen">
      ...
      <div className="flex">
        {/* Sidebar */}
        <aside className={cn(
          "fixed inset-y-0 left-0 z-40 w-64 border-r border-[var(--border)] bg-[var(--sidebar)] transition-transform lg:translate-x-0",
                ...
                return (
                  <Link
                    ...
                    className={cn(
                      ...
                      isActive 
                        ? "bg-[var(--sidebar-accent)] text-[var(--neon-cyan)]" 
                  ...
                  >
                    ...
                    {isActive && (
                      <motion.div
                        layoutId="activeNav"
                        className="ml-auto size-1.5 rounded-full bg-[var(--neon-cyan)]"
                      />
                    )}
                  </Link>
                )
